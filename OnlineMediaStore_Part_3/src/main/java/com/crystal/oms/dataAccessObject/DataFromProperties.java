...
public class DataFromProperties {
    ...
    public static DigitalVideoDisc getProperties() {
        ...
        try {
            ...
            FileInputStream input = new FileInputStream("OnlineMediaStore_Part_3/src/main/resources/media.properties");
    ...
    public static void setProperties(DigitalVideoDisc digitalVideoDisc) {
        try {
            ...
            FileOutputStream output = new FileOutputStream("OnlineMediaStore_Part_3/src/main/resources/media.properties");
